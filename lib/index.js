var tool = (function (exports) {
    ...
    */
    ...
    class RouterEvent extends EventEmitter {
        self;
        routeStack = [window.location.href];
        prevIndex = 0;
        currentIndex = 0;
        laggingPopStateEvent = null;
        hashBackOrForward_pauseAddRoute2Stack = false;
        ...
        hashChangeEvent(event) {
            ...
            if (this.hashBackOrForward_pauseAddRoute2Stack) {
        ...
        popstateEvent(event) {
            ...
            if (current !== this.routeStack[this.currentIndex]) {
                if (current === this.routeStack[this.currentIndex + 1]) {
        ...
        forwardEvent(delta = 1) {
            console.log('js_api前进');
            this.emit('forward');
            this.hashBackOrForward_pauseAddRoute2Stack = true;
            this.moveCurrentIndex(delta);
        }
        browserForwardButtonEvent() {
        ...
        go(go) {
            return (...args) => {
                ...
                if (delta > 0) {
                    if (historyLen - this.currentIndex < delta) {
    ...
    const App = () => {
        ...
        return React.createElement("div", { onClick: onclick }, "copy");
    };
